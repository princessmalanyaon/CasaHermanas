      ...
      <div class="container-xxl py-5">
        <div class="container">
          ...
          <div class="row g-5">
            ...
            <form class="col-lg-6" method="post" action="bookingcode.php">
                ...
                <div class="navbar-nav mr-auto py-0">
                  ...
                  <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 m-0">
                      <a href="room.html" class="dropdown-item">Rooms</a>
                      <a href="grazing.html" class="dropdown-item"
                        >Grazing Table</a
                      >
                      <a href="bar.html" class="dropdown-item">Mobile Bar</a>
                      <a href="cafe.html" class="dropdown-item">Mobile Cafe</a>
                  ...
                  <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 m-0">
                      <a href="booking.html" class="dropdown-item active"
                        >Rooms</a
                      >
                      <a href="catering.html" class="dropdown-item"
                        >Events & Catering Services</a
                      >
                    </div>
                  </div>
              ...
              <div class="wow fadeInUp" data-wow-delay="0.2s">
                <form>
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100 py-3" type="submit" action="index.html">
                        Book Now
                      </button>
                    </div>
                  </div>
